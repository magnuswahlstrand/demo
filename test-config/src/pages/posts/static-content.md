...
**Code challenge:** Try editing the `title` frontmatter property for this post and [visiting the homepage](/) again.s
...
function getDistance2(amount: number) {
  if (amount === Infinity) {
    return "and beyond!";
  } else {
