...
function Bread() {
  const obj = useLoader(OBJLoader, path + "/3DBread009_SQ.obj");

  const ref = useRef(null);
  const [ao, color, normal] = useTexture([
    path + "/3DBread009_LQ-1K_AmbientOcclusion.jpg", path + "/3DBread009_LQ-1K_Color.jpg", path + "/3DBread009_LQ-1K_NormalDX.jpg"]);
